...
export const POSTS: Post[] = [
  {
    ...
    channelId: 'channel-1',
    contentType: 'Artigo',
    text: 'Acabei de publicar um novo guia sobre React Server Components. O futuro do desenvolvimento web está mudando rápido! 🚀 #React #WebDev',
  ...
  },
  {
    ...
    userId: 'user-3',
    channelId: 'channel-3',
    contentType: 'Discussão',
    text: 'Como vocês estão lidando com a priorização de bugs técnicos vs. novas features no Q3? Alguma metodologia específica além do RICE?',
  ...
  },
  {
    ...
    text: 'Menos é mais. O design minimalista não é sobre a ausência de coisas, mas a presença de clareza.',
    timestamp: 'Ontem',
